 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_1[TASK_1_STACK_SIZE];	/* Task 1 (tsk_auto) */
    #endif
    ...
    #define TASK_3_STACK_SIZE 2000/4 // size = 2000 bytes
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_handleEvents) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 2000/4 // size = 2000 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_handleEvents) */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,Tsk3	 /* tsk_handleEvents*/
    #endif
    #if EE_MAX_TASK > 3
        ,Tsk4	 /* tsk_handleEvents*/
    #endif
    #if EE_MAX_TASK > 4
        ,Tsk5	 /* Task_5*/
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        {0}
        #ifdef TASK_1_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_1[(TASK_1_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_auto*/
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_background*/
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_handleEvents*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_handleEvents*/
        #endif
        #ifdef TASK_5_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #if EE_MAX_TASK > 0
    DeclareTask(tsk_auto);
    #endif
    #if EE_MAX_TASK > 1
    DeclareTask(tsk_background);
    #endif
    #if EE_MAX_TASK > 2
    DeclareTask(tsk_handleEvents);
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_handleEvents);
    #endif
    ...
    #if EE_MAX_TASK > 0
        &EE_oo_thread_stub       /* thread tsk_auto */
    #endif
    #if EE_MAX_TASK > 1
        ,&EE_oo_thread_stub      /* thread tsk_background */
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread tsk_handleEvents */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_handleEvents */
    #endif
