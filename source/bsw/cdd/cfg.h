...
#define MAX_JSON_STRING_LENGTH 200   /**< Maximum length of a JSON string. */
#define UART_Terminator '#'          /**< Terminator character for UART communication. */
#define MAX_JSMN_TOKENS 50           /**< Maximum number of tokens for JSMN parser. */
