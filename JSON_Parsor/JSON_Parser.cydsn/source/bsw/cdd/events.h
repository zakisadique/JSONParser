 ...
 */
struct sEvent {
    RB_EV_t m_evBuffer; /**< Buffer for the event. */
};
typedef struct sEvent EVENT_t;
 ...
 * @param me Pointer to the event instance.
...
/**
 * @brief Reads an event from the event buffer.
 * @param me Pointer to the event instance.
 * @param event Pointer to store the read event.
 * @return Status code indicating success or failure.
 */
RC_t EVENT_read(EVENT_t *const me, eEvent_t *const event);

/**
 * @brief Clears the event buffer.
 * @param me Pointer to the event instance.
 * @return Status code indicating success or failure.
 */
RC_t EVENT_clear(EVENT_t *const me);
