// ======================================================================
// JSON_Parser.v generated from TopDesign.cysch
// 02/11/2024 at 22:55
...
module top ;
	...
	cy_clock_v1_0
		#(.id("c619252b-e959-47e0-9776-b3e74234a6f3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
    ...
    SPI_Master_v2_50_3 TFT_SPI (
        .clock(1'b0),
        .miso(Net_158),
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_160),
        .sclk(wTFT_SCL),
        .sdat(Net_161),
        .ss(Net_162),
        .tx_interrupt(Net_163));
